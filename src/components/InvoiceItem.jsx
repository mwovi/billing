...
const InvoiceItem = ({
  ...
  return (
    <tr className="border-gray-900/10">
      <td className="min-w-[65px] border-gray-900/10 md:min-w-[80px]">
        <InvoiceField
      ...
      <td className="min-w-[30px] md:min-w-[30px]">
        <h3 id="total2" value="67" name="total2">{price * qty}</h3>
        {/* <InvoiceField
          onEditItem={(event) => onEdtiItem(event)}
          cellData={{
            type: "number",
